...
/**
 * A product entry in the list of cocktails.
 */
class ProductEntry(
    val name: String, dynamicUrl: String, val url: String, val recipe: String, val description: String) {
    ...
    companion object {
        ...
        fun initProductEntryList(resources: Resources): List<ProductEntry> {
            val inputStream = resources.openRawResource(R.raw.cocktails)
